...
# Function to update player data for a single game
...
# Initialize a list to store game history
game_history = []

# Streamlit interface
available_players = player_data.keys()  # Get all player names initially

# Add a section to enter game details and update the table
...
# Convert game history to pandas DataFrame
df_history = pd.DataFrame(game_history)

# Display game history as a table
st.dataframe(df_history)

# Convert player data to pandas DataFrame and display
