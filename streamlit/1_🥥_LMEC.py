...
st.markdown("1. En 🥝 **Jugadores**, pueden añadir nuevos jugadores. Cuando usen esto, ya deberíamos tener toda la lista y deberían usarlo solo para meter gente nueva.") 
st.markdown("2. Se van a 🥭 **Equipos** y cada jueves se escogen los seis jugadores para cada equipo. Se puede hacer antes de la mejenga.")
